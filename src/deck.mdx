...
<MainContent>
  <BasicGrid columns={1}>
    ...
    <GridItem>React docs still largely use classes</GridItem>
  </BasicGrid>
</MainContent>
...
- Redux Toolkit tutorial -- skip to Advanced or will have problems later
- Million ways to skin a cat, again... many different configurations
- - Immur - can write mutable code, no worries about immutable syntax
...
# Exploring CRA Redux Template (Redux Toolkit©)
...
- Store configuration - adds reducer, imports a slice reducer
...
- - actions in reducers object, uses Immur (BEWARE)
...
- - Async thunk defined outside of slice, (passedVal) => (dispatch, getState) => ...
- - selector to grab piece of state
- BEWARE of Immur - may want to maintain traditional Reaxt cloning syntax
...
- - dispatch actions with useDispatch, imported from react-redux
...
# Other Options for Global State: Easy Peasy, MobX, XState

<div style={{display:'flex', width:'100%'}}>

<div style={{ height: "100vh", flex: "1 1 33%" }}>
  <IframeLoader src={`https://easy-peasy.now.sh/`} title={`Easy Peasy`} />
</div>

<div style={{ height: "100vh", flex: "1 1 33%" }}>
  <IframeLoader src={`https://mobx.js.org/README.html`} title={`MOBX`} />
</div>
...
- Redux Toolkit or Easy Peasy for medium-large projects
